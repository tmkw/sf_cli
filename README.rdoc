...
This is a Ruby class library, which is thin wrapper of Salesforce CLI[https://developer.salesforce.com/docs/atlas.en-us.sfdx_cli_reference.meta/sfdx_cli_reference/cli_reference_top.htm] commands. <br>
Currently it simulates only *sf* command and just some functions are supported.
...
== Documents
You can generate rdoc documents. For example,
  $ git clone https://github.com/tmkw/sf_cli.git
  $ cd sf_cli
  $ gem install hanna
  $ rdoc -o doc -f hanna README.rdoc CHANGELOG.md lib

then you can find index.html in the doc directory. Open it by the internet browser.
