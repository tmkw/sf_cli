...
[{SfCli::Sf::Apex::Run#run sf apex run}]
  Run apex code
[{SfCli::Sf::Apex::Generate#generate_class sf apex generate class}]
  Generate an Apex class
[{SfCli::Sf::Apex::Generate#generate_trigger sf apex generate trigger}]
...
[{SfCli::Sf::Lightning::Generate#generate_component sf lightning component}]
...
[{SfCli::Sf::Project::DeployStart#deploy_start sf project deploy start}]
